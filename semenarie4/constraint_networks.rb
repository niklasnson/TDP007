...
# NN - had to rename to skip errors. Most likely due to the import in the 
...
class ArithmeticConstraint
  ...
  def new_value(connector)
    # updated function to take care of the out command aswell. 
    #
...
def celsius2fahrenheit
  c = Connector.new("c")
  f = Connector.new("f")
  multiplier = ConstantConnector.new("mc", (9.0/5.0))
  adder = ConstantConnector.new("ac", 32)

  t = Connector.new("t")
  Multiplier.new(c, multiplier, t)
  Adder.new(t, adder, f) 
  return c,f
end
